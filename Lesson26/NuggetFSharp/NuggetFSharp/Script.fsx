...
//@Now you try 26.1.5: After using "Generate References for F# Interactive" option, from the References node right click menu, use this in place of the above.
#load @"Scripts\load-project-debug.fsx" //Also, these files are regenerated whenever files or dependences are added to the project. Hooray, fsharp! \o/
